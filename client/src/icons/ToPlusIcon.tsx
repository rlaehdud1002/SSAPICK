...
const ToPlusIcon = ({
  ...
  return (
    <div className="flex flex-col justify-center">
      <div className="relative mx-5 mt-5 mb-2 h-[60px] w-[60px]">
        {profileImage ? (
          <img
