      ...
      <div className="mx-5 mt-5 mb-2" style={{ height: '60px', width: '60px' }}>
        ...
        {profileImage ? (
          ...
          {isPlus === true ? (
            ...
            <svg className="absolute bottom-1 -right-7 " width="16" height="16" viewBox="0 0 12 11" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <svg onClick={doClick} className="absolute bottom-1 -right-7" width="16" height="16" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
