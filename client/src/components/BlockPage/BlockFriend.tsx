    ...
    return (
        <div className="mb-20">
            ...
            blocks.map((block, index) => (
                <BlockFriendContent key={index} userId={block.userId} campusName={block.campusName} campusSection={block.campusSection} name={block.nickname} profileImage={block.profileImage} />
            ))):(
