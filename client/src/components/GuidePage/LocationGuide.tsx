...
const LocationGuide = () => {
  return (
    <div className="flex flex-col items-center my-10 p-6 bg-gray-100/50 rounded-lg shadow-lg max-w-full min-w-full px-4">
      <h1 className="text-3xl font-bold text-[#5f86e9] mb-5 text-center">Location 가이드</h1>
      ...
      <Carousel>
        <CarouselContent>
          <CarouselItem className="flex justify-center">
            <img width={200} src="icons/guide/Location.png" alt="Pick" />
          </CarouselItem>
          <CarouselItem className="flex justify-center">
            <img width={200} src="icons/guide/LocationPickco.png" alt="Pick" />
          </CarouselItem>
          <CarouselItem className="flex justify-center">
            <img width={200} src="icons/guide/LocationCatchOne.png" alt="Pick" />
          </CarouselItem>
          <CarouselItem className="flex justify-center">
            <img width={200} src="icons/guide/LocationPickco.png" alt="Pick" />
          </CarouselItem>
          <CarouselItem className="flex justify-center">
            <img width={200} src="icons/guide/LocationCatchTwo.png" alt="Pick" />
          </CarouselItem>
        </CarouselContent>
        <CarouselPrevious />
        <CarouselNext />
