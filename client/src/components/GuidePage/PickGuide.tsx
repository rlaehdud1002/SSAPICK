  ...
  return (
    <div className="flex flex-col items-center my-10 p-6 bg-gray-100/50 rounded-lg shadow-lg max-w-full min-w-full px-4">
      ...
      <div className="flex">
        ...
        <div className="flex flex-col items-center my-3 space-y-2 text-gray-700 text-center mx-10">
          <p className="text-prettty">랜덤한 질문이 나오고</p>
          <p className="text-prettty">같은 반, 친구 중에서 4명이 나옵니다</p>
          <p className="text-prettty">질문에 맞는 사람을 Pick!</p>
          <p className="text-prettty">Pick 당한 사람은 당신이 누군지 모릅니다</p>
          <p className="text-prettty">평소 친해지고 싶었던 사람과 친해질 수 있는 기회!</p>
          <p className="text-prettty">10개의 픽을 완료하면 픽코를 드립니다!</p>
          <p className="text-prettty">다음 픽을 하기위해서는 15분이 필요합니다!</p>
        </div>
      </div>
      ...
      <div className="flex">
        <p className="text-prettty mx-9 mt-32">
          Pick하고 싶은 친구가 없다면 셔플을 할 수 있습니다!
        </p>
        <Carousel className="my-5">
          <CarouselContent>
            <CarouselItem className="flex justify-center">
      ...
      <div className="flex">
        ...
        <div className="flex flex-col items-center my-3 space-y-2 text-gray-700 text-center mx-9 mt-24">
